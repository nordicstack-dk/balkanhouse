...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-burgundy to-burgundy-dark px-6 py-16 text-cream md:px-12 md:py-24">
      <div className="relative z-10 max-w-xl">
        ...
        <Link
          href="/shop"
          className="mt-8 inline-block rounded-lg bg-gold px-8 py-3 font-semibold text-burgundy-dark transition hover:bg-gold/90"
        >
          {t('shopNow')}
        </Link>
      </div>
